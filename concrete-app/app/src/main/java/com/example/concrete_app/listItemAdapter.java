...
public class listItemAdapter extends  ArrayAdapter<Basket> {
    ...
    public listItemAdapter(Context context, ArrayList<Basket> items) {
        super(context, R.layout.listviewlistitem, items);
    }
